...
if __name__ == "__main__":
    ...
    train_path = 'C:/Users/divya/OneDrive/Documents/student_resource 3/dataset/train.csv'
    ...
    download_images(train_images, download_folder=image_folder, num_workers=60)
